...
To acknowledge the specific version of the dataset used:
...
I. CONTENTS OF ftp://ftp.ncdc.noaa.gov/pub/data/ghcn/daily
...
II. FORMAT OF DATA FILES (".dly" FILES)
...
III. FORMAT OF "ghcnd-stations.txt"
...
IV. FORMAT OF "ghcnd-countries.txt"
